    ...
    <div className="w-full mb-8">
      ...
      <div className="relative mb-6">
        <div className="h-2.5 bg-slate-100 rounded-full overflow-hidden p-0.5 border border-slate-200/60">
          <div
            className="h-full bg-gradient-to-r from-amber-500 via-[#65a30d] to-emerald-700 rounded-full transition-all duration-700 ease-out"
          ...
          return (
            <button
              ...
              className={clsx(
                ...
                isCurrent && "bg-emerald-50/90 border-emerald-300 shadow-md shadow-emerald-100 cursor-default",
            ...
            >
              <div
                className={clsx(
                  ...
                  isCurrent && "bg-[#65a30d] text-white shadow-md shadow-emerald-200 scale-105",
