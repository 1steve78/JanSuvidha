...
export default function HowItWorks() {
  const steps = [
    {
      number: "01",
      title: "Enter Details",
      description: "Fill household profile or snap a geotagged photo",
      icon: FileText,
      badge: "Step 1",
    ...
    },
    {
      number: "02",
      title: "Get Matched",
      description: "AI & rule engine calculates eligible schemes with reasoning",
      icon: Cpu,
      badge: "Step 2",
    ...
    },
    {
      number: "03",
      title: "Apply & Track",
      description: "1-click submission with a direct anonymous tracking ID",
      icon: CheckCircle2,
      badge: "Step 3",
  ...
  return (
    /* No extra py padding — SnapSection handles vertical centering */
        ...
        <ScrollReveal preset="fade-left" className="lg:w-[32%] w-full">
          <div className="space-y-4">
            ...
            <p className="text-slate-500 text-base leading-relaxed">
              Three verifiable steps to welfare matching and grievance resolution.
            </p>
          </div>
        </ScrollReveal>
