...
const RESTRICTED_RESOURCES = [
  { icon: BarChart3, label: "District Intelligence Dashboard", color: "text-slate-800 bg-blue-50 border-blue-200" },
  { icon: FileSearch, label: "Complaint Investigation Center", color: "text-slate-800 bg-slate-100 border-slate-300" },
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer group">
            <input
              ...
              className="w-4 h-4 rounded border-slate-300 text-slate-800 focus:ring-blue-500"
            />
          ...
          <button
            type="button"
            className="text-xs font-semibold text-slate-800 hover:text-blue-700 transition-colors"
          >
            Forgot password?
          </button>
        </div>
    ...
    >
      <div className="px-5 py-4 border-b border-[#E4ECF8] flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <ShieldCheck className="w-4.5 h-4.5 text-slate-800" />
    ...
    <div className="flex flex-col min-h-screen bg-[#F8FBFF] text-slate-900">
      ...
      <div className="flex-1 min-w-0 flex flex-col relative overflow-x-hidden">
        ...
        <div className="p-4 sm:p-6 lg:p-8 space-y-8 max-w-7xl mx-auto w-full">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-2.5 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-xs font-medium text-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-1000 cursor-pointer"
                          />
                        </div>
                        ...
                        <button
                          ...
                          className="w-full bg-slate-800 hover:bg-slate-900 text-white font-bold py-1.5 rounded-lg text-xs transition-all shadow-xs"
                        >
                          Apply Range
                        </button>
                      </div>
                ...
                <div className="flex items-center gap-2.5">
                  <button
                    ...
                    className="flex items-center gap-2 bg-slate-800 hover:bg-slate-900 text-white font-semibold px-4 py-2.5 rounded-xl transition-all text-xs shadow-sm hover:shadow-md"
                  >
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-xs group hover:border-slate-400 transition-all">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5 pb-3 border-b border-slate-100">
                <div>
                  <Link href="/admin/priority" className="inline-flex items-center gap-2 group-hover:text-slate-800 transition-colors">
                    <AlertTriangle className="w-5 h-5 text-amber-500" />
                    <h3 className="text-base sm:text-lg font-extrabold text-slate-900 tracking-tight group-hover:text-slate-800">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Link
                    href="/admin/priority"
                    className="inline-flex items-center gap-1.5 text-xs font-extrabold bg-slate-800 hover:bg-slate-900 text-white px-3.5 py-2 rounded-xl transition-all shadow-xs"
                  >
                    ...
                    <tbody className="divide-y divide-slate-100 text-slate-700">
                      {urgentPriorityItems.slice(0, 5).map((item) => (
                        <tr key={item.id} className="hover:bg-slate-50/80 transition-colors">
                          ...
                          <td className="p-3">
                            <span className="px-2.5 py-1 rounded-md text-[11px] font-bold bg-slate-100 text-slate-900 border border-slate-200">
                              {item.category}
                            </span>
                          </td>
                          ...
                          <td className="p-3 text-right">
                            <Link
                              href="/admin/priority"
                              className="text-xs bg-slate-100 hover:bg-slate-200 text-slate-900 font-bold px-3 py-1.5 rounded-lg border border-slate-300/60 transition-all inline-block"
                            >
                              Manage Priority
                            </Link>
                          </td>
